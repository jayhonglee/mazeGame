 ...
 * 3ebd47e756e799dc536%3frik%3dUlQLvcX1HJUhBA%26pid%3dImgRaw%26r%3d0&exph=347&expw=347
 * &q=Door+2D+PNG&simid=608041793330837035&FORM=IRPRST&ck=A92C5B618C823424C543CFCA994A9CC7&
 * selectedIndex=0&ajaxhist=0&ajaxserp=0*/
public class door extends gameObj{

	public door(GameManager gm,int x, int y, Image ig) {
		super(gm,x, y, ig);
	}
	public door(GameManager gm,int x,int y, int w, int h, Image ig) {
		super(gm,x, y, w, h, ig);
		}
